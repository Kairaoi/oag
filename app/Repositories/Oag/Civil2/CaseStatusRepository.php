...
class CaseStatusRepository extends CustomBaseRepository
{
    /**
    ...
    public function update(int $id, array $data): Model
    {
        ...
        if (!$model) {
            throw new \Exception("Case status not found.");
        }
...
// }
    ...
    /**
     * Get all case statuses (with optional trashed).
     *
     * @param bool $trashed
     * @return Collection
     */
