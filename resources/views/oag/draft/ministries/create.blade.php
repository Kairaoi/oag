...
<div class="container mt-5">
    ...
    <h1 class="text-center mb-4">Create New Ministry</h1>

    <form action="{{ route('draft.ministry.store') }}" method="POST" class="p-4 shadow-lg rounded" style="background: linear-gradient(90deg, #ff416c, #ff4b2b); border-radius: 20px;">
        @csrf
        ...
        <button type="submit" class="btn btn-primary btn-block mt-4">Create Ministry</button>
    </form>
</div>
@endsection
