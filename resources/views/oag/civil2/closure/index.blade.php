    ...
    return `
        <div class="dropdown">
            ...
            <ul class="dropdown-menu p-3" aria-labelledby="dropdown-${id}" style="min-width: 250px;">
                <li>
                    <a class="dropdown-item" href="${window.location.origin}/civil2/cases/${id}">
                        Show
                    </a>
                </li>
                <li>
                    <a class="dropdown-item" href="${window.location.origin}/civil2/cases/${id}/edit">
                        Edit
                    </a>
                </li>
                <li>
                    ...
                    <form id="delete-form-${id}" action="${window.location.origin}/civil2/cases/${id}" method="POST" class="d-none">
                        @csrf
                        @method('DELETE')
                    </form>
                </li>
                ...
                <li class="form-check px-3">
                    <input class="form-check-input" type="radio" name="task-${id}" id="review-${id}" onclick="location.href='${window.location.origin}/civil2/cases/${id}/review'">
                    <label class="form-check-label" for="review-${id}">Review Case</label>
                </li>
                <li class="form-check px-3">
                    <input class="form-check-input" type="radio" name="task-${id}" id="close-${id}" onclick="location.href='${window.location.origin}/civil2/cases/${id}/close'">
                    <label class="form-check-label" for="close-${id}">Close Case</label>
                </li>
                <li class="form-check px-3">
                    <input class="form-check-input" type="radio" name="task-${id}" id="reopen-${id}" onclick="location.href='${window.location.origin}/civil2/cases/${id}/reopen'">
